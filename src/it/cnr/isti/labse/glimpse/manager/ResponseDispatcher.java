...
//		if (notified == false) {
//			new ClientLogging(LOGGINGSERVERPARAMETER).generalLogMessage("Monitoring detects a security violation");
//			notified = true;
//		}
		try {
			Thread.sleep(10000);
...
//		if (notified == false) {
//					new ClientLogging(LOGGINGSERVERPARAMETER).generalLogMessage("Monitoring detects a violation");
//					notified = true;
//				}
	}
}
