...
import it.cnr.isti.labse.glimpse.impl.TransformerImpl;
...
public class GlimpseManager extends Thread implements MessageListener {
	...
	public void onMessage(Message arg0) {
		...
		try {
			...
			DebugMessages.line();			
			DebugMessages.println(TimeStamp.getCurrentTime(), this.getClass().getSimpleName(),"receives " + msg.getText());
			DebugMessages.line();
			...
			if (XMLRule.contains("ComplexEventRuleActionList")) {
				...
				rules = transformer.convertInputModel(XMLRule)
						.getComplexEventRuleActionList();
			}
